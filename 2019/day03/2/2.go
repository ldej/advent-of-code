...
func main() {
	...
	grid, originX, originY = drawLine(grid, line1, originX, originY, true)
	grid, originX, originY = drawLine(grid, line2, originX, originY, false)
}
...
func drawLine(grid [][]int, line []string, startX int, startY int, addTrail bool) ([][]int, int, int) {
